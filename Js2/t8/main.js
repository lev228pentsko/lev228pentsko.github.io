class Order{
    constructor(product_name, product_price, user_email, count = 1 ,
        delivery, submitted = false, save = false){
...
class Admin{
    ...
    static deleteOrder(id){
        db.collection('orders').doc(id).delete().then( () => alert('Order deleted!') )
    }
    
}

Admin.approveOrder('IVuXmywTpwHBHf8gWofy');
